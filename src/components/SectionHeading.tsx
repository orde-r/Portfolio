...
export function SectionHeading({ eyebrow, title, description }: SectionHeadingProps) {
  return (
    <header className="mb-10 grid gap-5 border-t border-[var(--border)] pt-5 md:mb-14 md:grid-cols-[0.8fr_2fr] md:gap-12">
      {eyebrow && (
        <p className="w-fit self-start rounded-full border border-white/60 bg-white/42 px-3 py-2 text-[0.62rem] font-semibold uppercase tracking-[0.19em] text-[var(--text-muted)] shadow-sm backdrop-blur-xl">
          {eyebrow}
        </p>
      )}
      <div>
